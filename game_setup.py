...
intro_room = Classes_and_functions.Room('intro','images/intro.png')
intro_door = Classes_and_functions.Door((0,0),'images/intro.png','images/intro.png',room1A,True)
intro_room.add_door(intro_door)
...
##Set starting room##
room_list.change_room(intro_room)
